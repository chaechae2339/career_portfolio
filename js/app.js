(() => {
  ...
  const resumeSections = [
    ...
    },
    {
      ...
      items: [
        { period: '2026.05', title: '실질적 사회공헌의 현실', desc: '한국사회복지협의회' },
        { period: '2025.07', title: '사회공헌 전략과 기획', desc: '행복나눔재단 20주년 기념 컨퍼런스' },
  ...
  const projects = [
    {
      tag: '청년 자립 · 콘텐츠 기획', title: '쉼터 거주 청년 자립 프로젝트: 오롯이, 나',
      desc: '쉼터 거주 청년이 마주하는 자립의 사각지대를 발견하고, 낙관성에 근거해 심리적 회복을 돕고 스스로 자립할 수 있는 심리적 자원을 발견하는 자립 지원 프로그램을 기획·운영했습니다.',
      color: ACCENT, category: 'social', detailPage: 'projects/project-1.html',
    },
    {
      tag: '아동 복지', title: '아동 웰빙 척도 개발 프로젝트',
      desc: '한국 아동의 낮은 웰빙 지수라는 문제에서 출발하여 아동을 주인공으로, 스스로 답변할 수 있는 아동 웰빙 척도를 개발하고, 증가하는 아동 돌봄 공백을 해결하기 위한 새로운 공간에 도입을 제안했습니다.',
      color: ACCENT, category: 'social', detailPage: 'projects/project-2.html',
    },
    {
      tag: 'ESG · 임팩트 리포트', title: '포니정재단 20주년 임팩트 리포트 발간 및 성과 아카이빙',
      desc: '재단 설립 20주년을 맞아 20년 간의 사업 성과를 데이터화한 임팩트 리포트를 발간하고, 포니정 정신의 재정의를 통해 미래 재단 방향성을 재수립했습니다.',
    ...
    },
    {
      ...
      background: '글로벌 ESG 공시 규제 강화에 따라, 건설업 특성에 맞는 ESG 전략 수립과 공신력 있는 지속가능경영보고서 발간이 시급한 과제였습니다.',
      findings: [
